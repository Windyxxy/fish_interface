...
const (
	CatchType_CatchType_None    CatchType = 0
	CatchType_CatchType_Perfect CatchType = 1
	CatchType_CatchType_Good    CatchType = 2
	CatchType_CatchType_Finish  CatchType = 3
)

// Enum value maps for CatchType.
var (
	CatchType_name = map[int32]string{
		0: "CatchType_None",
		1: "CatchType_Perfect",
		2: "CatchType_Good",
		3: "CatchType_Finish",
	}
	CatchType_value = map[string]int32{
		"CatchType_None":    0,
		"CatchType_Perfect": 1,
		"CatchType_Good":    2,
		"CatchType_Finish":  3,
...
func (x CatchType) Enum() *CatchType {
	p := new(CatchType)
	*p = x
	return p
}

func (x CatchType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CatchType) Descriptor() protoreflect.EnumDescriptor {
	return file_fish_proto_enumTypes[3].Descriptor()
}

func (CatchType) Type() protoreflect.EnumType {
	return &file_fish_proto_enumTypes[3]
}

func (x CatchType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CatchType.Descriptor instead.
func (CatchType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	RewardType_RewardType_None RewardType = 9  // 无
	RewardType_AddTime         RewardType = 10 // 延长时间
	RewardType_ThrowCnt        RewardType = 11 // 投掷次数
)
...
func (RewardType) Descriptor() protoreflect.EnumDescriptor {
	return file_fish_proto_enumTypes[4].Descriptor()
}

func (RewardType) Type() protoreflect.EnumType {
	return &file_fish_proto_enumTypes[4]
}
...
// 续局
type ContinueType int32

const (
	ContinueType_ContinueType_None              ContinueType = 0 // 表示取消
	ContinueType_ContinueType_PSNotEnough_Adv   ContinueType = 1 // 体力不足看广告
	ContinueType_ContinueType_PSNotEnough_Share ContinueType = 2 // 体力不足分享
	ContinueType_ContinueType_PSNotEnough_Coin  ContinueType = 3 // 体力不足代币
	ContinueType_ContinueType_Reward_LowTen     ContinueType = 4 // 奖励低于10%
	ContinueType_ContinueType_Reward_None       ContinueType = 5 // 没有奖励
	ContinueType_ContinueType_Reward_Blue       ContinueType = 6 // 奖励蓝色
)

// Enum value maps for ContinueType.
var (
	ContinueType_name = map[int32]string{
		0: "ContinueType_None",
		1: "ContinueType_PSNotEnough_Adv",
		2: "ContinueType_PSNotEnough_Share",
		3: "ContinueType_PSNotEnough_Coin",
		4: "ContinueType_Reward_LowTen",
		5: "ContinueType_Reward_None",
		6: "ContinueType_Reward_Blue",
	}
	ContinueType_value = map[string]int32{
		"ContinueType_None":              0,
		"ContinueType_PSNotEnough_Adv":   1,
		"ContinueType_PSNotEnough_Share": 2,
		"ContinueType_PSNotEnough_Coin":  3,
		"ContinueType_Reward_LowTen":     4,
		"ContinueType_Reward_None":       5,
		"ContinueType_Reward_Blue":       6,
	}
)

func (x ContinueType) Enum() *ContinueType {
	p := new(ContinueType)
	*p = x
	return p
}

func (x ContinueType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ContinueType) Descriptor() protoreflect.EnumDescriptor {
	return file_fish_proto_enumTypes[5].Descriptor()
}

func (ContinueType) Type() protoreflect.EnumType {
	return &file_fish_proto_enumTypes[5]
}

func (x ContinueType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ContinueType.Descriptor instead.
func (ContinueType) EnumDescriptor() ([]byte, []int) {
...
type FishInfo struct {
	...
	ConfigId int32 `protobuf:"varint,5,opt,name=configId,proto3" json:"configId" msgpack:"configId"`
}
...
func (x *FishInfo) GetConfigId() int32 {
	if x != nil {
		return x.ConfigId
	}
	return 0
...
type ScFishSceneInfo struct {
	...
	ItemId int32 `protobuf:"varint,3,opt,name=itemId,proto3" json:"itemId" msgpack:"itemId"`
}
...
func (x *ScFishSceneInfo) GetItemId() int32 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
type ScFish struct {
	...
	Combo int32 `protobuf:"varint,2,opt,name=combo,proto3" json:"combo" msgpack:"combo"`
	// 类型 | @inject_tag: msgpack:"catchType" json:"catchType"
	CatchType CatchType `protobuf:"varint,3,opt,name=catchType,proto3,enum=fish.v1.CatchType" json:"catchType" msgpack:"catchType"`
	// Pvp道具Id | @inject_tag: msgpack:"itemId" json:"itemId"
	ItemId int32 `protobuf:"varint,4,opt,name=itemId,proto3" json:"itemId" msgpack:"itemId"`
}
...
func (x *ScFish) GetCatchType() CatchType {
	if x != nil {
		return x.CatchType
	}
	return CatchType_CatchType_None
}

func (x *ScFish) GetItemId() int32 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
type CsOperateSkill struct {
	...
	TargetId int32 `protobuf:"varint,2,opt,name=targetId,proto3" json:"targetId" msgpack:"targetId"`
}
...
func (x *CsOperateSkill) GetTargetId() int32 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
type CsOperateItem struct {
	...
	ItemId int32 `protobuf:"varint,1,opt,name=itemId,proto3" json:"itemId" msgpack:"itemId"`
	// 目标玩家 | @inject_tag: msgpack:"targetId" json:"targetId"
	TargetId int32 `protobuf:"varint,2,opt,name=targetId,proto3" json:"targetId" msgpack:"targetId"`
}
...
func (x *CsOperateItem) GetItemId() int32 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
func (x *CsOperateItem) GetTargetId() int32 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
type ScRewardInfo struct {
	...
	RewardInfo *RewardInfo `protobuf:"bytes,1,opt,name=rewardInfo,proto3" json:"rewardInfo" msgpack:"rewardInfo"`
}
...
func (x *GameOverFishInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameOverFishInfo) ProtoMessage() {}

func (x *GameOverFishInfo) ProtoReflect() protoreflect.Message {
	mi := &file_fish_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameOverFishInfo.ProtoReflect.Descriptor instead.
func (*GameOverFishInfo) Descriptor() ([]byte, []int) {
	return file_fish_proto_rawDescGZIP(), []int{21}
}

func (x *GameOverFishInfo) GetFishId() int32 {
	if x != nil {
		return x.FishId
	}
	return 0
...
func (x *GameOverFishInfo) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
type ScPveGameOverInfo struct {
	...
	GameOverFishInfos []*GameOverFishInfo `protobuf:"bytes,1,rep,name=gameOverFishInfos,proto3" json:"gameOverFishInfos" msgpack:"gameOverFishInfos"`
...
func (x *ScPveGameOverInfo) GetGameOverFishInfos() []*GameOverFishInfo {
	if x != nil {
		return x.GameOverFishInfos
	}
	return nil
}
...
type PvpRankInfo struct {
	...
	Init bool `protobuf:"varint,4,opt,name=init,proto3" json:"init" msgpack:"init"`
}
...
func (x *PvpRankInfo) GetInit() bool {
	if x != nil {
		return x.Init
	}
	return false
...
// 续局
type CsContinue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 续局的类型 | @inject_tag: msgpack:"continueType" json:"continueType"
	ContinueType ContinueType `protobuf:"varint,1,opt,name=continueType,proto3,enum=fish.v1.ContinueType" json:"continueType" msgpack:"continueType"`
}

func (x *CsContinue) Reset() {
	*x = CsContinue{}
	if protoimpl.UnsafeEnabled {
...
func (x *CsContinue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CsContinue) ProtoMessage() {}

func (x *CsContinue) ProtoReflect() protoreflect.Message {
	mi := &file_fish_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CsContinue.ProtoReflect.Descriptor instead.
func (*CsContinue) Descriptor() ([]byte, []int) {
	return file_fish_proto_rawDescGZIP(), []int{28}
}

func (x *CsContinue) GetContinueType() ContinueType {
	if x != nil {
		return x.ContinueType
	}
	return ContinueType_ContinueType_None
}

type ScContinue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 续局的时间 | @inject_tag: msgpack:"addTime" json:"addTime"
	AddTime int32 `protobuf:"varint,1,opt,name=addTime,proto3" json:"addTime" msgpack:"addTime"`
	// 续局的次数 | @inject_tag: msgpack:"addCount" json:"addCount"
	AddCount int32 `protobuf:"varint,2,opt,name=addCount,proto3" json:"addCount" msgpack:"addCount"`
}

func (x *ScContinue) Reset() {
	*x = ScContinue{}
	if protoimpl.UnsafeEnabled {
...
func (x *ScContinue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScContinue) ProtoMessage() {}

func (x *ScContinue) ProtoReflect() protoreflect.Message {
	mi := &file_fish_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScContinue.ProtoReflect.Descriptor instead.
func (*ScContinue) Descriptor() ([]byte, []int) {
	return file_fish_proto_rawDescGZIP(), []int{29}
}

func (x *ScContinue) GetAddTime() int32 {
	if x != nil {
		return x.AddTime
	}
	return 0
...
func (x *ScContinue) GetAddCount() int32 {
	if x != nil {
		return x.AddCount
	}
	return 0
...
// pvp 返回平台
type CsReturnPlatform struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CsReturnPlatform) Reset() {
	*x = CsReturnPlatform{}
	if protoimpl.UnsafeEnabled {
...
func (x *CsReturnPlatform) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CsReturnPlatform) ProtoMessage() {}

func (x *CsReturnPlatform) ProtoReflect() protoreflect.Message {
	mi := &file_fish_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CsReturnPlatform.ProtoReflect.Descriptor instead.
func (*CsReturnPlatform) Descriptor() ([]byte, []int) {
...
var file_fish_proto_rawDesc = []byte{
	...
	0x09, 0x66, 0x69, 0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x78, 0x0a, 0x08, 0x46, 0x69,
	...
	,
	...
	,
	...
	0x6e, 0x6b, 0x4e, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x22, 0x3f, 0x0a, 0x09, 0x53, 0x63, 0x50, 0x76,
	0x70, 0x52, 0x61, 0x6e, 0x6b, 0x12, 0x32, 0x0a, 0x09, 0x72, 0x61, 0x6e, 0x6b, 0x49, 0x6e, 0x66,
	0x6f, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x66, 0x69, 0x73, 0x68, 0x2e,
	0x76, 0x31, 0x2e, 0x50, 0x76, 0x70, 0x52, 0x61, 0x6e, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09,
	0x72, 0x61, 0x6e, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x97, 0x01, 0x0a, 0x0f, 0x50, 0x76,
	0x70, 0x47, 0x61, 0x6d, 0x65, 0x4f, 0x76, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x0a,
	...
	,
}
...
var file_fish_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_fish_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_fish_proto_goTypes = []interface{}{
	...
	(CatchType)(0),            // 3: fish.v1.CatchType
	(RewardType)(0),           // 4: fish.v1.RewardType
	(ContinueType)(0),         // 5: fish.v1.ContinueType
	(*ScGameStatus)(nil),      // 6: fish.v1.ScGameStatus
	(*CsLoad)(nil),            // 7: fish.v1.CsLoad
	(*ScLoad)(nil),            // 8: fish.v1.ScLoad
	(*SyncLoad)(nil),          // 9: fish.v1.SyncLoad
	(*RespGameInfo)(nil),      // 10: fish.v1.RespGameInfo
	(*PlayerInfo)(nil),        // 11: fish.v1.PlayerInfo
	(*ScPlayerInfos)(nil),     // 12: fish.v1.ScPlayerInfos
	(*BuffInfo)(nil),          // 13: fish.v1.BuffInfo
	(*ScBuffInfo)(nil),        // 14: fish.v1.ScBuffInfo
	(*FishPondInfo)(nil),      // 15: fish.v1.FishPondInfo
	(*FishGroupInfo)(nil),     // 16: fish.v1.FishGroupInfo
	(*FishInfo)(nil),          // 17: fish.v1.FishInfo
	(*ScGameStart)(nil),       // 18: fish.v1.ScGameStart
	(*ScFishSceneInfo)(nil),   // 19: fish.v1.ScFishSceneInfo
	(*CsFish)(nil),            // 20: fish.v1.CsFish
	(*CatchFishInfo)(nil),     // 21: fish.v1.CatchFishInfo
	(*ScFish)(nil),            // 22: fish.v1.ScFish
	(*CsOperateSkill)(nil),    // 23: fish.v1.CsOperateSkill
	(*CsOperateItem)(nil),     // 24: fish.v1.CsOperateItem
	(*RewardInfo)(nil),        // 25: fish.v1.RewardInfo
	(*ScRewardInfo)(nil),      // 26: fish.v1.ScRewardInfo
	(*GameOverFishInfo)(nil),  // 27: fish.v1.GameOverFishInfo
	(*ScPveGameOverInfo)(nil), // 28: fish.v1.ScPveGameOverInfo
	(*PvpRankInfo)(nil),       // 29: fish.v1.PvpRankInfo
	(*ScPvpRank)(nil),         // 30: fish.v1.ScPvpRank
	(*PvpGameOverInfo)(nil),   // 31: fish.v1.PvpGameOverInfo
	(*ScPvpGameOver)(nil),     // 32: fish.v1.ScPvpGameOver
	(*CsLeaveGame)(nil),       // 33: fish.v1.CsLeaveGame
	(*CsContinue)(nil),        // 34: fish.v1.CsContinue
	(*ScContinue)(nil),        // 35: fish.v1.ScContinue
	(*CsReturnPlatform)(nil),  // 36: fish.v1.CsReturnPlatform
}
var file_fish_proto_depIdxs = []int32{
	...
	11, // 2: fish.v1.ScPlayerInfos.playerInfos:type_name -> fish.v1.PlayerInfo
	2,  // 3: fish.v1.BuffInfo.bufType:type_name -> fish.v1.BuffType
	13, // 4: fish.v1.ScBuffInfo.buffInfos:type_name -> fish.v1.BuffInfo
	2,  // 5: fish.v1.ScBuffInfo.buffType:type_name -> fish.v1.BuffType
	17, // 6: fish.v1.FishGroupInfo.fishInfos:type_name -> fish.v1.FishInfo
	16, // 7: fish.v1.ScFishSceneInfo.fishGroupInfos:type_name -> fish.v1.FishGroupInfo
	15, // 8: fish.v1.ScFishSceneInfo.fisnPondInfo:type_name -> fish.v1.FishPondInfo
	21, // 9: fish.v1.ScFish.catchFishInfos:type_name -> fish.v1.CatchFishInfo
	3,  // 10: fish.v1.ScFish.catchType:type_name -> fish.v1.CatchType
	4,  // 11: fish.v1.RewardInfo.rewardType:type_name -> fish.v1.RewardType
	25, // 12: fish.v1.ScRewardInfo.rewardInfo:type_name -> fish.v1.RewardInfo
	27, // 13: fish.v1.ScPveGameOverInfo.gameOverFishInfos:type_name -> fish.v1.GameOverFishInfo
	25, // 14: fish.v1.ScPveGameOverInfo.rewardInfos:type_name -> fish.v1.RewardInfo
	29, // 15: fish.v1.ScPvpRank.rankInfos:type_name -> fish.v1.PvpRankInfo
	31, // 16: fish.v1.ScPvpGameOver.gameOverInfos:type_name -> fish.v1.PvpGameOverInfo
	5,  // 17: fish.v1.CsContinue.continueType:type_name -> fish.v1.ContinueType
