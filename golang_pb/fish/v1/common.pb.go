...
type RoleInfoRep struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// 配置角色ID| @inject_tag: msgpack:"role"
	RoleId int32 `protobuf:"varint,1,opt,name=roleId,proto3" json:"roleId,omitempty" msgpack:"role"`
}

func (x *RoleInfoRep) Reset() {
	*x = RoleInfoRep{}
	if protoimpl.UnsafeEnabled {
...
func (x *RoleInfoRep) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RoleInfoRep) ProtoMessage() {}

func (x *RoleInfoRep) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RoleInfoRep.ProtoReflect.Descriptor instead.
func (*RoleInfoRep) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{9}
}

func (x *RoleInfoRep) GetRoleId() int32 {
	if x != nil {
		return x.RoleId
	}
	return 0
...
var file_common_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x25, 0x0a, 0x0b,
	0x52, 0x6f, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x72,
	...
	0x6d, 0x2f, 0x78, 0x78, 0x79, 0x2f, 0x62, 0x6c, 0x6f, 0x6f, 0x64, 0x5f, 0x67, 0x61, 0x6d, 0x65,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x6c, 0x6f, 0x6f, 0x64, 0x2f, 0x76, 0x31, 0x3b,
...
var file_common_proto_goTypes = []interface{}{
	...
	(*RoleInfoRep)(nil),       // 9: blood.v1.RoleInfoRep
}
